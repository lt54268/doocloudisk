...
type TxyunServiceClient struct {
	c thrift.TClient
}

func NewTxyunServiceClientFactory(t thrift.TTransport, f thrift.TProtocolFactory) *TxyunServiceClient {
	return &TxyunServiceClient{
		c: thrift.NewTStandardClient(f.GetProtocol(t), f.GetProtocol(t)),
	}
}

func NewTxyunServiceClientProtocol(t thrift.TTransport, iprot thrift.TProtocol, oprot thrift.TProtocol) *TxyunServiceClient {
	return &TxyunServiceClient{
		c: thrift.NewTStandardClient(iprot, oprot),
	}
}

func NewTxyunServiceClient(c thrift.TClient) *TxyunServiceClient {
	return &TxyunServiceClient{
		c: c,
	}
}

func (p *TxyunServiceClient) Client_() thrift.TClient {
	return p.c
}

func (p *TxyunServiceClient) Upload(ctx context.Context, request *UploadReq) (r *UploadResp, err error) {
	var _args TxyunServiceUploadArgs
	_args.Request = request
	var _result TxyunServiceUploadResult
	if err = p.Client_().Call(ctx, "upload", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}
func (p *TxyunServiceClient) OfficeUpload(ctx context.Context, request *OfficeUploadReq) (r *OfficeUploadResp, err error) {
	var _args TxyunServiceOfficeUploadArgs
	_args.Request = request
	var _result TxyunServiceOfficeUploadResult
	if err = p.Client_().Call(ctx, "office_upload", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}
func (p *TxyunServiceClient) Save(ctx context.Context, request *SaveReq) (r *SaveResp, err error) {
	var _args TxyunServiceSaveArgs
	_args.Request = request
	var _result TxyunServiceSaveResult
	if err = p.Client_().Call(ctx, "save", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}
func (p *TxyunServiceClient) Download(ctx context.Context, request *DownloadReq) (r *DownloadResp, err error) {
	var _args TxyunServiceDownloadArgs
	_args.Request = request
	var _result TxyunServiceDownloadResult
	if err = p.Client_().Call(ctx, "download", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}
func (p *TxyunServiceClient) Remove(ctx context.Context, request *RemoveReq) (r *RemoveResp, err error) {
	var _args TxyunServiceRemoveArgs
	_args.Request = request
	var _result TxyunServiceRemoveResult
...
type TxyunServiceProcessor struct {
	processorMap map[string]thrift.TProcessorFunction
	handler      TxyunService
}

func (p *TxyunServiceProcessor) AddToProcessorMap(key string, processor thrift.TProcessorFunction) {
	p.processorMap[key] = processor
}

func (p *TxyunServiceProcessor) GetProcessorFunction(key string) (processor thrift.TProcessorFunction, ok bool) {
	processor, ok = p.processorMap[key]
	return processor, ok
}

func (p *TxyunServiceProcessor) ProcessorMap() map[string]thrift.TProcessorFunction {
	return p.processorMap
}

func NewTxyunServiceProcessor(handler TxyunService) *TxyunServiceProcessor {
	self := &TxyunServiceProcessor{handler: handler, processorMap: make(map[string]thrift.TProcessorFunction)}
	self.AddToProcessorMap("upload", &txyunServiceProcessorUpload{handler: handler})
	self.AddToProcessorMap("office_upload", &txyunServiceProcessorOfficeUpload{handler: handler})
	self.AddToProcessorMap("save", &txyunServiceProcessorSave{handler: handler})
	self.AddToProcessorMap("download", &txyunServiceProcessorDownload{handler: handler})
	self.AddToProcessorMap("remove", &txyunServiceProcessorRemove{handler: handler})
	return self
}
func (p *TxyunServiceProcessor) Process(ctx context.Context, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
...
type txyunServiceProcessorUpload struct {
	handler TxyunService
}

func (p *txyunServiceProcessorUpload) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := TxyunServiceUploadArgs{}
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := TxyunServiceUploadResult{}
...
type txyunServiceProcessorOfficeUpload struct {
	handler TxyunService
}

func (p *txyunServiceProcessorOfficeUpload) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := TxyunServiceOfficeUploadArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := TxyunServiceOfficeUploadResult{}
...
type txyunServiceProcessorSave struct {
	handler TxyunService
}

func (p *txyunServiceProcessorSave) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := TxyunServiceSaveArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
...
type txyunServiceProcessorDownload struct {
	handler TxyunService
}

func (p *txyunServiceProcessorDownload) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := TxyunServiceDownloadArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := TxyunServiceDownloadResult{}
...
type txyunServiceProcessorRemove struct {
	handler TxyunService
}

func (p *txyunServiceProcessorRemove) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := TxyunServiceRemoveArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := TxyunServiceRemoveResult{}
...
type TxyunServiceUploadArgs struct {
	Request *UploadReq `thrift:"request,1"`
}

func NewTxyunServiceUploadArgs() *TxyunServiceUploadArgs {
	return &TxyunServiceUploadArgs{}
}

func (p *TxyunServiceUploadArgs) InitDefault() {
}

var TxyunServiceUploadArgs_Request_DEFAULT *UploadReq

func (p *TxyunServiceUploadArgs) GetRequest() (v *UploadReq) {
	if !p.IsSetRequest() {
		return TxyunServiceUploadArgs_Request_DEFAULT
	}
	return p.Request
}

var fieldIDToName_TxyunServiceUploadArgs = map[int16]string{
	1: "request",
}

func (p *TxyunServiceUploadArgs) IsSetRequest() bool {
	return p.Request != nil
}

func (p *TxyunServiceUploadArgs) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_TxyunServiceUploadArgs[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *TxyunServiceUploadArgs) ReadField1(iprot thrift.TProtocol) error {
	_field := NewUploadReq()
	if err := _field.Read(iprot); err != nil {
		return err
	}
...
func (p *TxyunServiceUploadArgs) Write(oprot thrift.TProtocol) (err error) {
...
func (p *TxyunServiceUploadArgs) writeField1(oprot thrift.TProtocol) (err error) {
...
func (p *TxyunServiceUploadArgs) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("TxyunServiceUploadArgs(%+v)", *p)

}

type TxyunServiceUploadResult struct {
	Success *UploadResp `thrift:"success,0,optional"`
}

func NewTxyunServiceUploadResult() *TxyunServiceUploadResult {
	return &TxyunServiceUploadResult{}
}

func (p *TxyunServiceUploadResult) InitDefault() {
}

var TxyunServiceUploadResult_Success_DEFAULT *UploadResp

func (p *TxyunServiceUploadResult) GetSuccess() (v *UploadResp) {
	if !p.IsSetSuccess() {
		return TxyunServiceUploadResult_Success_DEFAULT
	}
	return p.Success
}

var fieldIDToName_TxyunServiceUploadResult = map[int16]string{
	0: "success",
}

func (p *TxyunServiceUploadResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *TxyunServiceUploadResult) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_TxyunServiceUploadResult[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *TxyunServiceUploadResult) ReadField0(iprot thrift.TProtocol) error {
...
func (p *TxyunServiceUploadResult) Write(oprot thrift.TProtocol) (err error) {
...
func (p *TxyunServiceUploadResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
...
func (p *TxyunServiceUploadResult) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("TxyunServiceUploadResult(%+v)", *p)

}

type TxyunServiceOfficeUploadArgs struct {
	Request *OfficeUploadReq `thrift:"request,1"`
}

func NewTxyunServiceOfficeUploadArgs() *TxyunServiceOfficeUploadArgs {
	return &TxyunServiceOfficeUploadArgs{}
}

func (p *TxyunServiceOfficeUploadArgs) InitDefault() {
}

var TxyunServiceOfficeUploadArgs_Request_DEFAULT *OfficeUploadReq

func (p *TxyunServiceOfficeUploadArgs) GetRequest() (v *OfficeUploadReq) {
	if !p.IsSetRequest() {
		return TxyunServiceOfficeUploadArgs_Request_DEFAULT
	}
	return p.Request
}

var fieldIDToName_TxyunServiceOfficeUploadArgs = map[int16]string{
	1: "request",
}

func (p *TxyunServiceOfficeUploadArgs) IsSetRequest() bool {
	return p.Request != nil
}

func (p *TxyunServiceOfficeUploadArgs) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_TxyunServiceOfficeUploadArgs[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *TxyunServiceOfficeUploadArgs) ReadField1(iprot thrift.TProtocol) error {
...
func (p *TxyunServiceOfficeUploadArgs) Write(oprot thrift.TProtocol) (err error) {
...
func (p *TxyunServiceOfficeUploadArgs) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("request", thrift.STRUCT, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := p.Request.Write(oprot); err != nil {
...
func (p *TxyunServiceOfficeUploadArgs) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("TxyunServiceOfficeUploadArgs(%+v)", *p)

}

type TxyunServiceOfficeUploadResult struct {
	Success *OfficeUploadResp `thrift:"success,0,optional"`
}

func NewTxyunServiceOfficeUploadResult() *TxyunServiceOfficeUploadResult {
	return &TxyunServiceOfficeUploadResult{}
}

func (p *TxyunServiceOfficeUploadResult) InitDefault() {
}

var TxyunServiceOfficeUploadResult_Success_DEFAULT *OfficeUploadResp

func (p *TxyunServiceOfficeUploadResult) GetSuccess() (v *OfficeUploadResp) {
	if !p.IsSetSuccess() {
		return TxyunServiceOfficeUploadResult_Success_DEFAULT
	}
	return p.Success
}

var fieldIDToName_TxyunServiceOfficeUploadResult = map[int16]string{
	0: "success",
}

func (p *TxyunServiceOfficeUploadResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *TxyunServiceOfficeUploadResult) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_TxyunServiceOfficeUploadResult[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *TxyunServiceOfficeUploadResult) ReadField0(iprot thrift.TProtocol) error {
...
func (p *TxyunServiceOfficeUploadResult) Write(oprot thrift.TProtocol) (err error) {
...
func (p *TxyunServiceOfficeUploadResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
		if err = oprot.WriteFieldBegin("success", thrift.STRUCT, 0); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *TxyunServiceOfficeUploadResult) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("TxyunServiceOfficeUploadResult(%+v)", *p)

}

type TxyunServiceSaveArgs struct {
	Request *SaveReq `thrift:"request,1"`
}

func NewTxyunServiceSaveArgs() *TxyunServiceSaveArgs {
	return &TxyunServiceSaveArgs{}
}

func (p *TxyunServiceSaveArgs) InitDefault() {
}

var TxyunServiceSaveArgs_Request_DEFAULT *SaveReq

func (p *TxyunServiceSaveArgs) GetRequest() (v *SaveReq) {
	if !p.IsSetRequest() {
		return TxyunServiceSaveArgs_Request_DEFAULT
	}
	return p.Request
}

var fieldIDToName_TxyunServiceSaveArgs = map[int16]string{
	1: "request",
}

func (p *TxyunServiceSaveArgs) IsSetRequest() bool {
	return p.Request != nil
}

func (p *TxyunServiceSaveArgs) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_TxyunServiceSaveArgs[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *TxyunServiceSaveArgs) ReadField1(iprot thrift.TProtocol) error {
	_field := NewSaveReq()
	if err := _field.Read(iprot); err != nil {
		return err
	}
...
func (p *TxyunServiceSaveArgs) Write(oprot thrift.TProtocol) (err error) {
...
func (p *TxyunServiceSaveArgs) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("request", thrift.STRUCT, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := p.Request.Write(oprot); err != nil {
...
func (p *TxyunServiceSaveArgs) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("TxyunServiceSaveArgs(%+v)", *p)

}

type TxyunServiceSaveResult struct {
	Success *SaveResp `thrift:"success,0,optional"`
}

func NewTxyunServiceSaveResult() *TxyunServiceSaveResult {
	return &TxyunServiceSaveResult{}
}

func (p *TxyunServiceSaveResult) InitDefault() {
}

var TxyunServiceSaveResult_Success_DEFAULT *SaveResp

func (p *TxyunServiceSaveResult) GetSuccess() (v *SaveResp) {
	if !p.IsSetSuccess() {
		return TxyunServiceSaveResult_Success_DEFAULT
	}
	return p.Success
}

var fieldIDToName_TxyunServiceSaveResult = map[int16]string{
	0: "success",
}

func (p *TxyunServiceSaveResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *TxyunServiceSaveResult) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_TxyunServiceSaveResult[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *TxyunServiceSaveResult) ReadField0(iprot thrift.TProtocol) error {
	_field := NewSaveResp()
	if err := _field.Read(iprot); err != nil {
		return err
	}
...
func (p *TxyunServiceSaveResult) Write(oprot thrift.TProtocol) (err error) {
...
func (p *TxyunServiceSaveResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
		if err = oprot.WriteFieldBegin("success", thrift.STRUCT, 0); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *TxyunServiceSaveResult) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("TxyunServiceSaveResult(%+v)", *p)

}

type TxyunServiceDownloadArgs struct {
	Request *DownloadReq `thrift:"request,1"`
}

func NewTxyunServiceDownloadArgs() *TxyunServiceDownloadArgs {
	return &TxyunServiceDownloadArgs{}
}

func (p *TxyunServiceDownloadArgs) InitDefault() {
}

var TxyunServiceDownloadArgs_Request_DEFAULT *DownloadReq

func (p *TxyunServiceDownloadArgs) GetRequest() (v *DownloadReq) {
	if !p.IsSetRequest() {
		return TxyunServiceDownloadArgs_Request_DEFAULT
	}
	return p.Request
}

var fieldIDToName_TxyunServiceDownloadArgs = map[int16]string{
	1: "request",
}

func (p *TxyunServiceDownloadArgs) IsSetRequest() bool {
	return p.Request != nil
}

func (p *TxyunServiceDownloadArgs) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_TxyunServiceDownloadArgs[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *TxyunServiceDownloadArgs) ReadField1(iprot thrift.TProtocol) error {
...
func (p *TxyunServiceDownloadArgs) Write(oprot thrift.TProtocol) (err error) {
...
func (p *TxyunServiceDownloadArgs) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("request", thrift.STRUCT, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := p.Request.Write(oprot); err != nil {
...
func (p *TxyunServiceDownloadArgs) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("TxyunServiceDownloadArgs(%+v)", *p)

}

type TxyunServiceDownloadResult struct {
	Success *DownloadResp `thrift:"success,0,optional"`
}

func NewTxyunServiceDownloadResult() *TxyunServiceDownloadResult {
	return &TxyunServiceDownloadResult{}
}

func (p *TxyunServiceDownloadResult) InitDefault() {
}

var TxyunServiceDownloadResult_Success_DEFAULT *DownloadResp

func (p *TxyunServiceDownloadResult) GetSuccess() (v *DownloadResp) {
	if !p.IsSetSuccess() {
		return TxyunServiceDownloadResult_Success_DEFAULT
	}
	return p.Success
}

var fieldIDToName_TxyunServiceDownloadResult = map[int16]string{
	0: "success",
}

func (p *TxyunServiceDownloadResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *TxyunServiceDownloadResult) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_TxyunServiceDownloadResult[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *TxyunServiceDownloadResult) ReadField0(iprot thrift.TProtocol) error {
...
func (p *TxyunServiceDownloadResult) Write(oprot thrift.TProtocol) (err error) {
...
func (p *TxyunServiceDownloadResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
		if err = oprot.WriteFieldBegin("success", thrift.STRUCT, 0); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *TxyunServiceDownloadResult) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("TxyunServiceDownloadResult(%+v)", *p)

}

type TxyunServiceRemoveArgs struct {
	Request *RemoveReq `thrift:"request,1"`
}

func NewTxyunServiceRemoveArgs() *TxyunServiceRemoveArgs {
	return &TxyunServiceRemoveArgs{}
}

func (p *TxyunServiceRemoveArgs) InitDefault() {
}

var TxyunServiceRemoveArgs_Request_DEFAULT *RemoveReq

func (p *TxyunServiceRemoveArgs) GetRequest() (v *RemoveReq) {
	if !p.IsSetRequest() {
		return TxyunServiceRemoveArgs_Request_DEFAULT
	}
	return p.Request
}

var fieldIDToName_TxyunServiceRemoveArgs = map[int16]string{
	1: "request",
}

func (p *TxyunServiceRemoveArgs) IsSetRequest() bool {
	return p.Request != nil
}

func (p *TxyunServiceRemoveArgs) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_TxyunServiceRemoveArgs[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *TxyunServiceRemoveArgs) ReadField1(iprot thrift.TProtocol) error {
	_field := NewRemoveReq()
	if err := _field.Read(iprot); err != nil {
		return err
	}
...
func (p *TxyunServiceRemoveArgs) Write(oprot thrift.TProtocol) (err error) {
...
func (p *TxyunServiceRemoveArgs) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("request", thrift.STRUCT, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := p.Request.Write(oprot); err != nil {
...
func (p *TxyunServiceRemoveArgs) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("TxyunServiceRemoveArgs(%+v)", *p)

}

type TxyunServiceRemoveResult struct {
	Success *RemoveResp `thrift:"success,0,optional"`
}

func NewTxyunServiceRemoveResult() *TxyunServiceRemoveResult {
	return &TxyunServiceRemoveResult{}
}

func (p *TxyunServiceRemoveResult) InitDefault() {
}

var TxyunServiceRemoveResult_Success_DEFAULT *RemoveResp

func (p *TxyunServiceRemoveResult) GetSuccess() (v *RemoveResp) {
	if !p.IsSetSuccess() {
		return TxyunServiceRemoveResult_Success_DEFAULT
	}
	return p.Success
}

var fieldIDToName_TxyunServiceRemoveResult = map[int16]string{
	0: "success",
}

func (p *TxyunServiceRemoveResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *TxyunServiceRemoveResult) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_TxyunServiceRemoveResult[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *TxyunServiceRemoveResult) ReadField0(iprot thrift.TProtocol) error {
...
func (p *TxyunServiceRemoveResult) Write(oprot thrift.TProtocol) (err error) {
...
func (p *TxyunServiceRemoveResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
		if err = oprot.WriteFieldBegin("success", thrift.STRUCT, 0); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *TxyunServiceRemoveResult) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("TxyunServiceRemoveResult(%+v)", *p)
