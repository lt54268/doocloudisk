...
func newFileContent(db *gorm.DB, opts ...gen.DOOption) fileContent {
	...
	_fileContent.fileContentDo.UseModel(&gorm_gen.FileContent{})
...
type fileContent struct {
	...
	ALL       field.Asterisk
	ID        field.Int64
	Fid       field.Int64  // 文件ID
	Content   field.String // 内容
	Text      field.String // 内容（主要用于文档类型搜索）
	Size      field.Int64  // 大小(B)
...
type IFileContentDo interface {
	...
	Create(values ...*gorm_gen.FileContent) error
	CreateInBatches(values []*gorm_gen.FileContent, batchSize int) error
	Save(values ...*gorm_gen.FileContent) error
	First() (*gorm_gen.FileContent, error)
	Take() (*gorm_gen.FileContent, error)
	Last() (*gorm_gen.FileContent, error)
	Find() ([]*gorm_gen.FileContent, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*gorm_gen.FileContent, err error)
	FindInBatches(result *[]*gorm_gen.FileContent, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*gorm_gen.FileContent) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*gorm_gen.FileContent, error)
	FirstOrCreate() (*gorm_gen.FileContent, error)
	FindByPage(offset int, limit int) (result []*gorm_gen.FileContent, count int64, err error)
...
func (f fileContentDo) Create(values ...*gorm_gen.FileContent) error {
	if len(values) == 0 {
		return nil
	}
...
func (f fileContentDo) CreateInBatches(values []*gorm_gen.FileContent, batchSize int) error {
	return f.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (f fileContentDo) Save(values ...*gorm_gen.FileContent) error {
	if len(values) == 0 {
		return nil
	}
...
func (f fileContentDo) First() (*gorm_gen.FileContent, error) {
	if result, err := f.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*gorm_gen.FileContent), nil
	}
}

func (f fileContentDo) Take() (*gorm_gen.FileContent, error) {
...
func (f fileContentDo) Last() (*gorm_gen.FileContent, error) {
...
func (f fileContentDo) Find() ([]*gorm_gen.FileContent, error) {
	result, err := f.DO.Find()
	return result.([]*gorm_gen.FileContent), err
}

func (f fileContentDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*gorm_gen.FileContent, err error) {
	buf := make([]*gorm_gen.FileContent, 0, batchSize)
...
func (f fileContentDo) FindInBatches(result *[]*gorm_gen.FileContent, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (f fileContentDo) FirstOrInit() (*gorm_gen.FileContent, error) {
...
func (f fileContentDo) FirstOrCreate() (*gorm_gen.FileContent, error) {
...
func (f fileContentDo) FindByPage(offset int, limit int) (result []*gorm_gen.FileContent, count int64, err error) {
...
func (f fileContentDo) Delete(models ...*gorm_gen.FileContent) (result gen.ResultInfo, err error) {
